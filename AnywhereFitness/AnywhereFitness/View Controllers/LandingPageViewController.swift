...
class LandingPageViewController: UIViewController {
            ...
            networkController.logIn(with: userLogin) { result in
                ...
                case .success(let credentials):
                    ...
                    DispatchQueue.main.async {
                        ...
                        case 123:
                            let insboard = UIStoryboard(name: "InstructorSignUp", bundle: nil)
                            let instructorVC = insboard.instantiateViewController(identifier: "instructorVC")
    ...
    func displayLogInSuccessAlert() {
        let alertController = UIAlertController(title: "Logged In Successful!",
